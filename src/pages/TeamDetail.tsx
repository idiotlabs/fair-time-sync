...
Generated by FairMeet`;
  ...
  const createSampleTeam = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('create-sample-team', {
        body: { teamId: team.id }
      });
      ...
      toast({
        title: "샘플 팀 생성 완료",
        description: `${data.members}명의 멤버와 ${data.suggestions}개의 추천이 생성되었습니다.`,
      });
      ...
      toast({
        title: "샘플 팀 생성 실패",
        description: error.message || 'Failed to create sample team',
        variant: "destructive",
      });
    } finally {
      setLoading(false);
                   ...
                   {canManage && (
                     <div className="flex space-x-2">
                       ...
                       >
                         ...
                         {loading ? "생성 중..." : "Try with sample team"}
                       </Button>
